...
[![Latest Stable Version](https://img.shields.io/packagist/v/alextrellez/laravel-queue-monitor.svg?style=flat-square)](https://packagist.org/packages/alextrellez/laravel-queue-monitor)
[![Total Downloads](https://img.shields.io/packagist/dt/alextrellez/laravel-queue-monitor.svg?style=flat-square)](https://packagist.org/packages/alextrellez/laravel-queue-monitor)
[![License](https://img.shields.io/packagist/l/alextrellez/laravel-queue-monitor.svg?style=flat-square)](https://packagist.org/packages/alextrellez/laravel-queue-monitor)
[![GitHub Build Status](https://img.shields.io/github/workflow/status/alextrellez/Laravel-Queue-Monitor/Tests?style=flat-square)](https://github.com/alextrellez/Laravel-Queue-Monitor/actions)
...
```
composer require alextrellez/laravel-queue-monitor
```
...
```
php artisan vendor:publish --provider="alextrellez\QueueMonitor\Providers\QueueMonitorProvider"
```
...
To monitor a job, simply add the `alextrellez\QueueMonitor\Traits\IsMonitored` Trait.
...
See the [full configuration file](https://github.com/alextrellez/Laravel-Queue-Monitor/blob/master/config/queue-monitor.php) for more information.

![Preview](https://raw.githubusercontent.com/alextrellez/Laravel-Queue-Monitor/master/preview.png)
...
- [Upgrade from 1.0 to 2.0](https://github.com/alextrellez/Laravel-Queue-Monitor/releases/tag/2.0.0)
